...
enum class TextId {
    ...
    NspRecovery, NoNspInstallWillStart, Files, DriveError, SharedWithMe,
    MyDrive, EmptyFolder, BrowseHint, Library, NoIndexedDownloads,
    LocalFile, RemovedAfterInstall, ManagedNspInstalled, LibraryHint,
    MissingFile, RemoveShortcutQuestion, RemoveShortcut, RemoveNsp,
    NoManagedNsp, BaseRemovalWarning, RemoveConfirm, RemovalFailed,
    Home, Settings, NoAccountConnected, ActiveAccount, OpenFiles,
    CleanupAfterInstall, Yes, No, ToggleCleanup, AddAccount, ChangeLanguage,
    NavigationHint, Exit, Language,
    ...
    CnmtSwitchOnly, SystemContentMountFailed, CnmtPrepareFailed,
